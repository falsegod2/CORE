...
class WorldModel(nn.Module):
    """Single-RSSM DreamerV3 world model with the shared intrinsic shaping head."""
    ...
    def _train(
        ...
        with tools.RequiresGrad(self.actor):
            with torch.cuda.amp.autocast(self._use_amp):
                ...
                intrinsic = intrinsic_objective(imag_feat, imag_state, imag_action)
                reward = reward + self._config.intrinsic_reward_scale * intrinsic
